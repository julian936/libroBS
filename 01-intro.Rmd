...
```{r lag-plots, echo=FALSE,  warning=FALSE, fig.height=8, fig.width=12, fig.cap="Gráficos de rezago para lag 1 y lag 7 días. La concentración de puntos en la diagonal sugiere autocorrelación positiva, especialmente en lag 1."}
