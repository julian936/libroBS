...
```{r vis-forecast-test, fig.height=6, fig.width=10, fig.cap="Pronóstico de Prophet vs Valores Reales - Conjunto de Prueba"}
...
```{r vis-forecast-original, fig.height=6, fig.width=10, fig.cap="Pronóstico de Prophet vs Valores Reales - Escala Original"}
...
```{r prophet-multiples, warning=FALSE, message=FALSE, results='hide'}
