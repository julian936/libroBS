...
- **Retornos simples:** +10%, luego -10% → Total: $100 × 1.10 × 0.90 = \$99$ (INCORRECTO - no es 0%)
- **Retornos logarítmicos:** +9.53%, luego -10.54% → Total: 9.53% - 10.54% = -1.01% (CORRECTO - se suman directamente)
...
└────────────────────┬────────────────────────────────────────────┘
                     │
                     ├─► ADF sobre retornos
                     ├─► TODOS estacionarios (p < 0.01) [CORRECTO]
                     ├─► Media constante (~0%)
...
║  Propiedades:                                                    ║
║    • Estacionarios I(0) [CONFIRMADO]                            ║
║    • Media constante [CONFIRMADO]                               ║
║    • Volatilidad variable (clusters)                            ║
