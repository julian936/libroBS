  ...
  if(usar_plotly) {
    ...
    fig <- plotly::subplot(
      ...
      plot_ly(height = 220) %>%
        ...
        layout(
          xaxis = list(title = ""),
          yaxis = list(title = "Farmacéutica - Índice (Base 100)"),
          annotations = list(
            list(
              text = "Farmacéutica",
      ...
      plot_ly(height = 220) %>%
        ...
        layout(
          ...
          yaxis = list(title = "Tecnología - Índice (Base 100)"),
          annotations = list(
            list(
              text = "Tecnología",
              x = 0.5, xref = "paper", xanchor = "center",
      ...
      layout(
        title = list(
          text = "Comparación de Desempeño Normalizado por Sector",
          font = list(size = 16)
        ),
        showlegend = TRUE,
        legend = list(
    ...
    p <- ggplot(datos_normalizados, 
      ...
      annotate("rect", 
               ...
               alpha = 0.1, fill = "red") +
      labs(
        title = "Comparación de Desempeño Normalizado por Sector",
